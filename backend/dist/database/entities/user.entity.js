...
exports.User = exports.OrganizerStatus = exports.UserRole = void 0;
...
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], User.prototype, "selfieUrl", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], User.prototype, "organizerStatus", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => organizer_entity_1.Organizer, (organizer) => organizer.user),
